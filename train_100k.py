#!/usr/bin/env python3
"""Standalone 100K timestep PPO training script."""
import sys
import warnings
...
from rl_regime_agent import RLTrainer
import pandas as pd
...
print(f'Starting 100K timestep PPO training...', flush=True)
print('=' * 70, flush=True)
...
print('=' * 70, flush=True)
print('Evaluating trained model (5 episodes)...', flush=True)
...
print(f'  Regime dist:   {eval_results["regime_distribution"]}', flush=True)
